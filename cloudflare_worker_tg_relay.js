...
// Set a Secret named TG_BOT_TOKEN with your bot token in dashboard.
const ALLOW_ORIGIN = "*"; // TODO: for better security, set to your domain
  ...
  async fetch(request, env) {
    ...
    try {
      ...
      const body = new URLSearchParams({
        ...
        disable_web_page_preview: String(disable_web_page_preview ?? true)
      });
